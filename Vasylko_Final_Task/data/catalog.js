window.catalog = [{
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/levis_women_jeans.png', // replace with path to image extracted from catalog layout
    ...
    colors: ['Blue'],
    sizes: ['UK 18'],
    thumbnail: 'img/blue.png', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    thumbnail: 'img/black.png', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
...
window.nextCatalog = [
    {
        ...
        colors: [],
        sizes: [],
        thumbnail: 'img/levis_women_jeans.png', // replace with image extracted from item layout
        preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
    }, {
...
console.log(window.catalog[12]["id"])
